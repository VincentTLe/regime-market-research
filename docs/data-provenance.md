...
permanently, so they help set the scale of every feature that is scored. The
Japanese reconstruction is different in kind, because it is scored directly:
our official N225TR mirror begins only
