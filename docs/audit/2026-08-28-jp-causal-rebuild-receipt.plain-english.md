<!-- NOT THE FROZEN RECEIPT. This is a plain-English paraphrase of
docs/audit/2026-08-28-jp-causal-rebuild-receipt.md, written by the same AI
assistant on 2026-08-28 for PR #33 and split out into its own file on
2026-09-01 after review (the receipt itself is a frozen record and stays
byte-identical to the version sealed with PR #31). Where the two disagree,
